    ...
    <section className="bg-black text-white px-4 sm:px-8 py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-7xl mx-auto">
            ...
            <div className="flex items-center">
              ...
              >
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 -mt-1">Customer</p>
                </div>
              </div>
            </div>

            <div>
              <p className="text-[14px] sm:text-[16px] font-normal text-[#FFFDF4] leading-snug">
                Delighted Guests Always <br className="hidden sm:block" />{" "}
                Welcome
              </p>
              <button className="text-[9px] text-white mt-2 border border-[#9F9F9F] rounded-full px-[11px] py-[6px]">
                See Review
              </button>
            </div>
          </div>
        ...
        <div>
          ...
          <p className="text-[#9F9F9F] mt-4 text-[16px] sm:text-base">
          ...
          <button className="mt-[14px] inline-flex items-center gap-2 text-[#9F9F9F] underline ">
            See More
            <span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 text-white">
            <div className="bg-[#111111] p-6 rounded-2xl flex flex-col justify-between sm:col-span-1 relative">
              <div className="text-center">
                <p className="text-6xl  font-semibold leading-tight">95%</p>
                <p className="text-[16px] mt-2 text-[#9F9F9F]">
                  Delighted Guests
                  <br />
                  Always Welcome
                </p>
            ...
            <div className="bg-[#111111]  rounded-2xl sm:col-span-2 flex justify-between items-center gap-0">
              <div className="max-w-[60%] p-6">
                <p className="lg:text-[24px] md:text-sm sm:text-sm font-medium">
                  Tasty Beginnings
                  <br />
                  to Savor
                </p>
                <p className="text-[14px] text-[#9F9F9F] mt-2">
                ...
                <button className="text-[12px] underline mt-3 text-[#9F9F9F]">
                  DETAILS
                </button>
              </div>
              <img
